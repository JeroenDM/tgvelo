...
function calcSpeed() {
    ...
    if( parseInt(document.getElementById("selectRpm").value) ) {
        rpm = 70;
    }
    document.getElementById("outputRpm").innerHTML = rpm;
    document.getElementById("speed").innerHTML = Math.round(distance * rpm / 60 * 3.6 *10)/10;
    // * 10 / 10 is for rounding on one decimal
}
